...
public class ConsoleSimulationRunner implements SimulationRunner{

    private EDACAlgorithm algorithm;
    private SignalGenerator signalGenerator;
    private DisruptionGenerator disruptionGenerator;

    public ConsoleSimulationRunner(EDACAlgorithm algorithm, SignalGenerator signalGenerator, DisruptionGenerator disruptionGenerator) {
